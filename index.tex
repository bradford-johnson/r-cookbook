...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# remove outliers steps}

\CommentTok{\# 1. get Q1 and Q3 }
\NormalTok{Q }\OtherTok{=} \FunctionTok{quantile}\NormalTok{(outlier\_df}\SpecialCharTok{$}\NormalTok{var1}\FloatTok{.1}\NormalTok{, }\AttributeTok{probs =} \FunctionTok{c}\NormalTok{(.}\DecValTok{25}\NormalTok{,.}\DecValTok{75}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{FALSE}\NormalTok{)}

\CommentTok{\# 2. get IQR}
\NormalTok{iqr }\OtherTok{=} \FunctionTok{IQR}\NormalTok{(outlier\_df}\SpecialCharTok{$}\NormalTok{var1}\FloatTok{.1}\NormalTok{)}

\CommentTok{\# 3. get upper and lower ranges}
\NormalTok{up }\OtherTok{\textless{}{-}}\NormalTok{  Q[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{+}\FloatTok{1.5}\SpecialCharTok{*}\NormalTok{iqr }\CommentTok{\# Upper Range  }
\NormalTok{low }\OtherTok{\textless{}{-}}\NormalTok{ Q[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{{-}}\FloatTok{1.5}\SpecialCharTok{*}\NormalTok{iqr }\CommentTok{\# Lower Range}

\CommentTok{\# 4. remove outliers (outlier\_df is the name of my data frame, var1.1 is the name of the column that I am removing outliers from)}

\NormalTok{no\_outliers\_p }\OtherTok{\textless{}{-}}\NormalTok{ outlier\_df }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(var1}\FloatTok{.1} \SpecialCharTok{\textgreater{}}\NormalTok{ low }\SpecialCharTok{\&}\NormalTok{ var1}\FloatTok{.1} \SpecialCharTok{\textless{}}\NormalTok{ up) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ var1}\FloatTok{.1}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{theme\_classic}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Without Outliers"}\NormalTok{) }\SpecialCharTok{+}
...
\CommentTok{\# patchwork to show plots}
\NormalTok{outlier\_p }\SpecialCharTok{/}\NormalTok{ no\_outliers\_p}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{./cleaning-data_files/figure-pdf/unnamed-chunk-8-1.pdf}
